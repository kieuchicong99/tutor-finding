# Generated by Django 2.2.6 on 2019-10-16 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tutor_app.Level')),
                ('id_mon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tutor_app.Mon_hoc')),
            ],
        ),
        migrations.AddField(
